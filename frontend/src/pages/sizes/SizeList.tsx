    ...
    <div className="w-full space-y-3">
      ...
      <div className="bg-gradient-to-r from-primary-600 to-primary-500 rounded-xl shadow-lg p-6 text-white">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-4xl font-bold mb-2">Manajemen Ukuran</h1>
            <p className="text-primary-100 text-lg">Kelola ukuran produk</p>
          </div>
          <Link to="/sizes/new">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6 hover:shadow-lg transition-all duration-300 group">
          ...
          <p className="text-sm font-medium text-gray-600 mb-1">Total Ukuran</p>
          <h3 className="text-3xl font-bold text-gray-900 mb-1">
            {isLoading ? "-" : pagination.total}
          </h3>
          <p className="text-xs text-gray-500">Semua ukuran terdaftar</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6 hover:shadow-lg transition-all duration-300 group">
          ...
          <p className="text-xs text-gray-500">Ukuran pada halaman ini</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6 hover:shadow-lg transition-all duration-300 group">
          ...
          <p className="text-sm font-medium text-gray-600 mb-1">Ukuran Aktif</p>
          <h3 className="text-3xl font-bold text-gray-900 mb-1">
            {isLoading
              ? "-"
              : sizes.filter((s: any) => s.isActive).length}
          </h3>
                  ...
                  <td colSpan={3} className="px-4 py-16 text-center">
                    <div className="flex flex-col items-center gap-4">
                      <div className="p-4 bg-gray-100 rounded-full">
                        <Maximize className="w-16 h-16 text-gray-400" />
                      </div>
                      <p className="text-gray-600 font-semibold text-lg">
                      ...
                      <Link to="/sizes/new">
                        <button className="mt-2 flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-primary-600 to-primary-500 text-white rounded-lg font-semibold hover:from-primary-700 hover:to-primary-600 shadow-lg transition-all">
                          <Plus className="w-5 h-5" />
                          <span>Tambah Ukuran Pertama</span>
                        </button>
                      </Link>
                    </div>
                  </td>
          ...
          <div className="bg-gradient-to-r from-gray-50 to-gray-100 px-4 py-3 border-t border-gray-200">
            <div className="flex items-center justify-between">
              <div className="text-sm text-gray-600">
                Menampilkan{" "}
                <span className="font-bold text-gray-900">{sizes.length}</span>{" "}
                dari{" "}
