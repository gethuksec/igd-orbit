    ...
    <div className="w-full space-y-3">
      ...
      <div className="bg-gradient-to-r from-primary-600 to-primary-500 rounded-xl shadow-lg p-6 text-white">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-4xl font-bold mb-2">Manajemen Ekspedisi</h1>
            <p className="text-primary-100 text-lg">Kelola ekspedisi pengiriman</p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6 hover:shadow-lg transition-all duration-300 group">
          ...
          <p className="text-sm font-medium text-gray-600 mb-1">Total Ekspedisi</p>
          <h3 className="text-3xl font-bold text-gray-900 mb-1">
            {isLoading ? "-" : pagination.total}
          </h3>
          <p className="text-xs text-gray-500">Semua ekspedisi terdaftar</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6 hover:shadow-lg transition-all duration-300 group">
          ...
          <h3 className="text-3xl font-bold text-gray-900 mb-1">
            {isLoading ? "-" : expeditions.length}
          </h3>
          <p className="text-xs text-gray-500">Ekspedisi pada halaman ini</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6 hover:shadow-lg transition-all duration-300 group">
          ...
          <p className="text-sm font-medium text-gray-600 mb-1">Ekspedisi Aktif</p>
          <h3 className="text-3xl font-bold text-gray-900 mb-1">
            {isLoading
              ? "-"
              : expeditions.filter((e: any) => e.isActive).length}
          </h3>
                  ...
                  >
                    ...
                    <td className="px-4 py-3 whitespace-nowrap text-right">
                      <div className="flex items-center justify-end gap-1">
                        ...
                        <Link to={`/expeditions/${expedition.id}/edit`}>
                          <button
