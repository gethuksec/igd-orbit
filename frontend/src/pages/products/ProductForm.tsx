  ...
  useEffect(() => {
    if (product) {
      ...
      setFormData({
        ...
        unit: typeof (product as any).unit === 'object' ? (product as any).unit?.name || '' : (product as any).unit || product.unit || 'pcs',
        size: typeof (product as any).size === 'object' ? (product as any).size?.name || '' : (product as any).size || '',
