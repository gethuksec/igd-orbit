...
export default function SmartRepairPage() {
  ...
  const handleOutletChange = (outlet: string) => { setF({ outlet, warehouseId: '', technicianId: '' }); setRows([]); setBarangWarehouseId(''); setProductDraft(null); setProductSearch(''); };
