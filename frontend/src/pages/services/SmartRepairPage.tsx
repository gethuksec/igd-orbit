...
export default function SmartRepairPage() {
  ...
  const handleSave = () => {
    ...
    saveMutation.mutate({
      ...
      estimatedCost: estimasiEfektif, finalPrice: estimasiEfektif, downPayment: downPayment || undefined, warrantyDays: form.isUnderWarranty ? Math.max(0, Number(form.warrantyDays || 30)) : undefined,
  ...
  const addLayanan = () => {
    ...
    setNewLayanan(''); setNewLayananCost(''); setOpenLayanan(false);
  };
