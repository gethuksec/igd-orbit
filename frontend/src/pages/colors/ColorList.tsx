    ...
    <div className="w-full space-y-3">
      ...
      <div className="bg-gradient-to-r from-primary-600 to-primary-500 rounded-xl shadow-lg p-6 text-white">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-4xl font-bold mb-2">Manajemen Warna</h1>
            <p className="text-primary-100 text-lg">Kelola warna produk</p>
          </div>
          <Link to="/colors/new">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6 hover:shadow-lg transition-all duration-300 group">
          ...
          <p className="text-sm font-medium text-gray-600 mb-1">Total Warna</p>
          <h3 className="text-3xl font-bold text-gray-900 mb-1">
            {isLoading ? "-" : pagination.total}
          </h3>
          <p className="text-xs text-gray-500">Semua warna terdaftar</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6 hover:shadow-lg transition-all duration-300 group">
          ...
          <p className="text-xs text-gray-500">Warna pada halaman ini</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6 hover:shadow-lg transition-all duration-300 group">
          ...
          <p className="text-sm font-medium text-gray-600 mb-1">Warna Aktif</p>
          <h3 className="text-3xl font-bold text-gray-900 mb-1">
            {isLoading
              ? "-"
              : colors.filter((c: any) => c.isActive).length}
          </h3>
                    ...
                    <div className="flex flex-col items-center gap-4">
                      ...
                      <Link to="/colors/new">
                        <button className="mt-2 flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-primary-600 to-primary-500 text-white rounded-lg font-semibold hover:from-primary-700 hover:to-primary-600 shadow-lg transition-all">
                          <Plus className="w-5 h-5" />
                          <span>Tambah Warna Pertama</span>
                        </button>
                      </Link>
                    </div>
                  </td>
