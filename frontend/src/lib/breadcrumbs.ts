...
const TRAILS: Record<string, Crumb[]> = {
  ...
  '/sales-types': [{ label: 'Master Data' }, { label: 'Tipe Customer' }],
  '/sales-types/new': [{ label: 'Master Data' }, { label: 'Tipe Customer', href: '/sales-types' }],
  '/sales-types/:id': [{ label: 'Master Data' }, { label: 'Tipe Customer', href: '/sales-types' }],
  '/sales-types/:id/edit': [{ label: 'Master Data' }, { label: 'Tipe Customer', href: '/sales-types' }],
