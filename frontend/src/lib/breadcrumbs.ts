...
const TRAILS: Record<string, Crumb[]> = {
  ...
  '/customer-types': [{ label: 'Master Data' }, { label: 'Tipe Customer' }],
  '/customer-types/new': [{ label: 'Master Data' }, { label: 'Tipe Customer', href: '/customer-types' }],
  '/customer-types/:id': [{ label: 'Master Data' }, { label: 'Tipe Customer', href: '/customer-types' }],
  '/customer-types/:id/edit': [{ label: 'Master Data' }, { label: 'Tipe Customer', href: '/customer-types' }],
